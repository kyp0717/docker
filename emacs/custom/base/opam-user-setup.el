...
;; ## added by OPAM user-setup for emacs / tuareg ## b7a54b1e1fbb6e924617e742166f6241 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/k8s/.opam/4.11.1/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
